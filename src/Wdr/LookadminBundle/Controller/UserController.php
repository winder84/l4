...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WdrLookadminBundle:User')->findAll();

        return $this->render('WdrLookadminBundle:User:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WdrLookadminBundle:User')->find($id);
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_users__edit', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_users__delete', array('id' => $id)))
            ->setMethod('DELETE')
